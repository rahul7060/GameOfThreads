...
const Jogger = () => {
  ...
  // Filter jogger products (case insensitive)
  const joggers = products.filter(
    (product) => product.category?.trim().toLowerCase() === "jogger"
  );
  ...
  const updatePage = (newPage) => {
    ...
    navigate(`/UserDashboard/jogger/${newPage}`);
    setPage(newPage);
  };
